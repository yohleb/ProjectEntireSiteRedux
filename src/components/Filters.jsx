...
const Filters = () => {
  ...
  const {searchh, company, category, shipping, order, price} = params;
  ...
  return (
    ...
    <FormInput type="searchhhh" label="search product" name="search" size="input-sm" defaultValue={searchh}/>
